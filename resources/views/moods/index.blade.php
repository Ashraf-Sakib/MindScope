<x-app-layout>
    <section class="text-center mt-10">
        <h2 class="text-2xl font-semibold text-gray-700">Welcome to MindScope</h2>
        <p class="text-gray-500 mt-2">Track your mood, check in daily, and see your progress.</p>
    </section>
    <section class="flex justify-center gap-4 mt-8">
        ...
        <button class="w-16 h-16 rounded-full bg-purple-100 hover:bg-purple-200 flex items-center justify-center text-2xl">Tired</button>
    ...
    <div class="mt-10 text-center">
        <a href="{{ route('dashboard') }}" class="bg-mint-200 hover:bg-mint-300 text-gray-700 py-2 px-6 rounded-xl font-medium">
            Go to Dashboard
        </a>
    </div>
</x-app-layout>
